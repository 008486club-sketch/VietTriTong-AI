          ...
          <div className={styles.content}>
            <section className={styles.section}>
              <p className={styles.introduction}>
                The following sets forth 越智通AI平台's Terms of Use. We know how tempting it is to skip
                these Terms of Use, but it's important to establish what you can expect from us as
                you use 越智通AI平台's Service, and what we expect from you. The Terms of Use is a
            ...
            <section className={styles.section}>
              <h2 className={styles.sectionTitle}>越智通AI平台, Inc Terms of Use</h2>
              <p className={styles.sectionContent}>
                Welcome, and thank you for your interest in 越智通AI平台, Inc. ("越智通AI平台," "we," or
                "us") and our website at ai.yuezhitong.com, along with our related websites, networks,
                ...
                binding contract between you and 越智通AI平台 regarding your use of the Service.
              </p>
              <p className={styles.sectionContent}>
                ...
                CONDITIONS, INCLUDING 越智通AI平台'S PRIVACY POLICY
                https://ai.yuezhitong.com/en/websit/privacy-policy AND ANY ADDITIONAL TERMS AND POLICIES
                越智通AI平台 MAY PROVIDE FROM TIME TO TIME (TOGETHER, THESE "TERMS").
              </p>
              <p className={styles.sectionContent}>
                ...
                binding, individual arbitration, and BY ACCEPTING THESE TERMS, YOU AND 越智通AI平台 ARE
            ...
            <section className={styles.section}>
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 reserves the right to modify or discontinue all or any portion of the
                Service at any time (including by limiting or discontinuing certain features of the
                Service), temporarily or permanently, without notice to you. 越智通AI平台 will have no
            ...
            <section className={styles.section}>
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 reserves the right to determine pricing for the Service. 越智通AI平台 will make
              ...
              <p className={styles.sectionContent}>
                You authorize 越智通AI平台 to charge all sums for the orders that you make and any level
                of Service you select as described in these Terms or published by 越智通AI平台,
                including all applicable taxes, to the payment method specified in your account. If
                you pay any fees with a credit card, then 越智通AI平台 may seek pre-authorization of
            ...
            <section className={styles.section}>
              <h2 className={styles.sectionTitle}>5. LICENSE TO 越智通AI平台 SERVICES</h2>
              <h3 className={styles.subSectionTitle}>5.1 Limited License</h3>
              <p className={styles.sectionContent}>
                Subject to your complete and ongoing compliance with these Terms, 越智通AI平台 grants
            ...
            <section className={styles.section}>
              ...
              <p className={styles.sectionContent}>
                The Service is owned and operated by 越智通AI平台. The visual interfaces, graphics,
                ...
                elements of the Service provided by 越智通AI平台 ("Materials") are protected by
                intellectual property and other laws. All Materials included in the Service are the
                property of 越智通AI平台 or its third-party licensors. Except as expressly authorized by
                越智通AI平台, you may not make use of the Materials.
              </p>
            </section>
            ...
            <section className={styles.section}>
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 respects the intellectual property rights of others, takes the protection
            ...
            <section className={styles.section}>
              ...
              <p className={styles.sectionContent}>
                ...
                access the Service and these Terms automatically terminate. In addition, 越智通AI平台
            ...
            <section className={styles.section}>
              ...
              <p className={styles.sectionContent}>
                TO THE FULLEST EXTENT PERMITTED BY LAW, IN NO EVENT WILL THE 越智通AI平台 ENTITIES BE
            ...
            <section className={styles.section}>
              ...
              <p className={styles.sectionContent}>
                In the interest of resolving disputes between you and 越智通AI平台 in the most expedient
                and cost effective manner, and except as described in the Arbitration provisions,
                you and 越智通AI平台 agree that every dispute arising in connection with these Terms,
                ...
                BY ENTERING INTO THESE TERMS, YOU AND 越智通AI平台 ARE EACH WAIVING THE RIGHT TO A TRIAL
            ...
            <section className={styles.section}>
              ...
              <p className={styles.sectionContent}>
                ...
                understanding and agreement between you and 越智通AI平台 regarding your use of the
            ...
            <section className={styles.section}>
              ...
              <p className={styles.sectionContent}>
                The Service is offered by 越智通AI平台, Inc. You may contact us by emailing us at
                hello@yuezhitong.com.
              </p>
            </section>
          </div>
