          ...
          <div className={styles.content}>
            <section className={styles.section}>
              <p className={styles.introduction}>
                越智通AI平台 provides this Privacy Policy to inform you of our policies and procedures
                regarding the collection, use, protection, and disclosure of Personal Information
                received from your use of this website, located at https://ai.yuezhitong.com (“Site”), as
              ...
              <p className={styles.sectionContent}>
                ...
                https://ai.yuezhitong.com/en/websit/terms-of-service.
              </p>
            </section>
            ...
            <section className={styles.section} id="section2">
              ...
              <p className={styles.sectionContent}>
                ...
                to submit the following types of Personal Information to 越智通AI平台: your name, email
            ...
            <section className={styles.section} id="section2a">
              ...
              <p className={styles.sectionContent}>
                If you connect your third party social media account to your 越智通AI平台 账号, we
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 may allow you to connect a Facebook page or profile to your 越智通AI平台
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 may allow you to connect a Twitter profile to your 越智通AI平台 账号, in
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 may allow you to connect an Instagram profile to your 越智通AI平台 账号, in
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 may allow you to connect a LinkedIn profile to your 越智通AI平台 账号, in
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 may allow you to connect a TikTok profile to your 越智通AI平台 账号, in
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 may allow you to connect a YouTube channel to your 越智通AI平台 账号, in
                ...
                access tokens, existing videos. 越智通AI平台 uses YouTube API Services and by using the
                YouTube integration via 越智通AI平台, you agree to be bound by the YouTube Terms of
                Service.
              </p>
            </section>
            ...
            <section className={styles.section} id="section2b">
              ...
              <p className={styles.sectionContent}>
                ...
                that we transfer to your computer's hard disk. 越智通AI平台 may use both session cookies
            ...
            <section className={styles.section} id="section3">
              ...
              <ul className={styles.listContent}>
                ...
                <li>provide tailored advertising, for 越智通AI平台 services, via Google AdWords;</li>
            ...
            <section className={styles.section} id="section4">
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 cooperates with government and law enforcement officials or private parties
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 may sell, transfer or otherwise share some or all of its assets, including
            ...
            <section className={styles.section} id="section5">
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 cares deeply about safeguarding the confidentiality of your personal
            ...
            <section className={styles.section} id="section6">
              ...
              <p className={styles.sectionContent}>
                ...
                by sending your request to us by email at hello@yuezhitong.com.
              </p>
              <p className={styles.sectionContent}>
            ...
            <section className={styles.section} id="section7">
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 complies with the EU-U.S. Data Privacy Framework, the Swiss-U.S. Data
            ...
            <section className={styles.section} id="section8">
              ...
              <p className={styles.sectionContent}>
                ...
                consent, he or she should contact us at hello@yuezhitong.com. We do not knowingly
            ...
            <section className={styles.section} id="section11">
              ...
              <div className={styles.contactInfo}>
                ...
                <p className={styles.contactText}>
                  越智通AI平台 Inc. is the entity responsible for the processing of your personal
