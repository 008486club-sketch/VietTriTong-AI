      ...
      <main className={styles.main}>
        <div className={styles.container}>
          <div className={styles.header}>
            <h1 className={styles.title}>越智通AI平台 Extension Privacy Policy</h1>
          ...
          <div className={styles.content}>
            <section className={styles.section}>
              <p className={styles.introduction}>
                This Privacy Policy describes how 越智通AI平台 Extension ("Extension", "we", "us", or
                "our") collects, uses, and protects information when you use our browser extension.
                By installing and using the 越智通AI平台 Extension, you agree to the collection and use
            ...
            <section className={styles.section} id="section1">
              ...
              <p className={styles.sectionContent}>
                越智通AI平台 Extension is a browser extension designed to help users automate content
                publishing, engagement, and social media tasks seamlessly with the 越智通AI平台 web
                platform (https://ai.yuezhitong.com). The extension works in conjunction with supported
            ...
            <section className={styles.section} id="section3">
              ...
              <p className={styles.sectionContent}>
                The 越智通AI平台 Extension requires certain browser permissions to function. Here's why
              ...
              <ul className={styles.listContent}>
                ...
                <li>ai.yuezhitong.com - For communication with 越智通AI平台 web platform</li>
              </ul>
            </section>
            ...
            <section className={styles.section} id="section4">
              ...
              <ul className={styles.listContent}>
                ...
                <li>To synchronize data with the 越智通AI平台 web platform</li>
            ...
            <section className={styles.section} id="section5">
              ...
              <p className={styles.sectionContent}>
                Certain data may be transmitted to and stored on 越智通AI平台 servers to enable
            ...
            <section className={styles.section} id="section7">
              ...
              <h3 className={styles.subSectionTitle}>With 越智通AI平台 Platform</h3>
              <p className={styles.sectionContent}>
                Data is shared between the extension and the 越智通AI平台 web platform to provide
              ...
              <p className={styles.sectionContent}>
                ...
                request, or to protect the rights, property, or safety of 越智通AI平台, our users, or
                others.
              </p>
            </section>
