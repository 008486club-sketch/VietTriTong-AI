...
export const footerResources: FooterLink[] = [
  { label: 'docs', href: 'https://docs.ai.yuezhitong.com/', external: true },
  { label: 'caseStudies', href: '/websit/case-studies' },
  { label: 'contact', href: '/websit/contact' },
]
...
export const footerContact = {
  email: 'hello@yuezhitong.com',
  emailHref: 'mailto:hello@yuezhitong.com',
  github: 'https://github.com/yuezhitong/VietTriThong',
}
