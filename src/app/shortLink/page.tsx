...
function BrandHeader() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
      <Image src={logo} alt="越智通AI平台" width={32} height={32} style={{ borderRadius: 8 }} />
      <span style={{ fontSize: 18, fontWeight: 600, color: colors.text, letterSpacing: '-0.025em' }}>越智通AI平台</span>
    </div>
  )
}
